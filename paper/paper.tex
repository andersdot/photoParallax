...
This is a fairly standard result which we illustrated in the introductory section of this paper: the deconvolution of uncertainties is stronger in noisier regions of the data, leading to narrower features in the upper part of the \cmd, for example.
