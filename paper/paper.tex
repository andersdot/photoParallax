...
For the majority of the \gaia\ stars, our prior slightly increases the precision of the posterior PDF compared with the \gaia\ variance. Our parallax posterior PDFs are more precise than the \tgas\ catalog entries by a median factor of $1.2$. This is visualized by Examples 1-4 in Figure~\ref{fig:posterior} which show slightly narrower posterior PDFs compared to the likelihoods.
However, $14\%$ of our parllax posterior PDFs are more precise than the \tgas\ catalog by a factor of $>2$. This larger change in precision is visualized in Example 5, which shows a significantly narrower posterior PDF compared to the likelihood.
...
Figure~\ref{fig:posteriorCMD} shows the distribution of the posterior parallax PDFs derived with our \cmd\ prior.
