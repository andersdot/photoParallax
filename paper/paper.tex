...
%\caption{Five example posterior PDFs over parallax using our method for more odd objects.
%The upper left panel shows the position of each example data point in black, with its observed uncertainties, plotted over our prior represented by a mixture of Gaussians in green. In blue, we show the posterior expectation value and $1 \sigma$ uncertainties. 
