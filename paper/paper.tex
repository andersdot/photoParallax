...
Examples 1-4 are not very affected by the prior (green), where good data is good data.
Example 4 is interesting because it lies in the same color range as the red clump, where there is a lot of support from the prior, but the likelihood does not have much support there so the parallax posterior pdf keeps the star on the main sequence.
...
Our prior tends to have the largest affect on stars in the red giant branch.}
\label{fig:posterior}
\end{figure}
