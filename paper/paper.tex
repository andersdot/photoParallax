...
\item[selection] The biggest limitation of our method for generating
  ...
  By modeling the selection function in detail, one could improve the quality of the inferred \cmb, its effect on individual objects, and its connection to physical models of the Milky Way. 
