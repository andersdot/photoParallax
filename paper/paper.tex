...
\begin{abstract}\noindent % trust me
{\bf \textcolor{red}{Stephen Feeeeeeeneeeeeey is the best.}} Converting a noisy parallax measurement into a posterior
...
Examples 1, 3, and 4 are not very effected by the prior (teal), where good data is good data.
Examples 2 and 5 show a more precise posterior PDF compared with the likelihood.
Example 5 looks very similar to the prior PDF and exemplifies that our prior tends to have the largest effect on stars in the red giant branch.}
\label{fig:posterior}
\end{figure}
...
XXX talk about specific examples}}
...
\added{As a second comparison of these photometric parallax inferences, we compare to the inferred distances to the stars from asteroseismology.  Asteroseimology can make much more precise distance, and therefore parallax, estimates to stars than the photometric parallax method. There are about $2200$ stars that overlap our data set here and the asteroseimic data from \citealt{huber17}. We compared the estimates in the parallax space (since the asteroseismic distance estimates are more precise, this is a safer comparison space since the inverted pdfs will be less skewed). We compare the cumulative difference in the parallax estimates in units of mas; the same units as the precision of \tgas. The comparison shows that our photo parallax estimates are more similar to the asteroseismic estimates than the \tgas\ likelihoods. The left panel and the middle panel show the one to one comparison of asteroseismic parallax estimates to the \tgas\ likelihoods and the photo parallax posterior pdf respectively for all $2200$ stars. The right panel shows the cumulative distribution function of the differences between the estimates for each star. The comparison to the photo parallax estimates, represented by the blue line, shows a distribution with smaller differences, and therefore more similar to the asteroseismic estimates.}
\begin{figure}
\centering
  \includegraphics[width=\textwidth]{photoVSseismic.pdf}
\caption{\added{Proof of concept: parallax estimate comparisons. All quantified comparisons in this figure are made between a parallax estimate from asteroseismology and a parallax estimate from \gaia, either the \tgas\ estimate or our photo parallax estimate. And the figure is meant to guide visual comparisons between \tgas\ and photo parallax, and therefore highlight differences in the estimates. The first panel shows the one to one comparison of the \tgas\ parallax estimates and the inverted distance estimates from \citealt{huber17}, and the associated $1\sigma$ uncertainties. The orange line shows the one to one line. The second panel is similar, but instead of the \tgas\ parallax estimates, it visualizes our photo parallax estimates. This shows the shrinkage of the precision of the parallax estimates, and that the expectation values are more in agreement with the asteroseismic estimates. The third panel panel visualizes the difference between the asteroseismic estimate and a \gaia\ estimate, \tgas\ in grey and photo parallax in blue, as a cumulative distribution function of the difference in units of mas. The photo parallax estimates are more similar to the asteroseismic estimates than \tgas\ likelihoods alone.}}
